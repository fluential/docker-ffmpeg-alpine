...
RUN         apk add --no-cache --update libgcc libstdc++ ca-certificates libcrypto1.1 libssl1.1 libgomp expat git frei0r-plugins-dev frei0r-plugins frei0r-plugins-dev frei0r-plugins gst-plugins-bad
